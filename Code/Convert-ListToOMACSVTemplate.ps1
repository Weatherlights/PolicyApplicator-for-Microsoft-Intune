...
$omaConfigFile = [PSCustomObject]@{
    ...
    "description" = ""
    "value" = "<enabled/><data id=`"$AppName-$cleanAppPolicyName-File-path`" value=`"$outFilePath`"/><data id=`"$AppName-$cleanAppPolicyName-File-createfile`" value=`"true`"/>";
...
For ( $i = 0; $i -lt $listFileContent.count; $i++ ) {
    ...
    $dataValueList += "$NrListEntry&#xF000;$listEntry&#xF000;"
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUloNdPCK6owjTbWbmH4Dzkrgz
# 2P2gghBKMIIE3DCCA8SgAwIBAgIRAP5n5PFaJOPGDVR8oCDCdnAwDQYJKoZIhvcN
...
# MQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUvOMmnRFShQeO4Cv2T1rC
# N01nPc0wDQYJKoZIhvcNAQEBBQAEggEAoX6odi2z2jtYtszT9jQzO/jgmM1d9TDG
# JXOjitD2YLnzPhvMUHYqnCMk2TRElUDuJbdH7JJvYIAxv9PW30oeKyTEx/jsJ9xP
# aHqC1ipM7YK1X5WJSA09tVmg+8pZMP3XtVWnCDa5ReUClY14E9xVrIqq5eyuBgPu
# R95Ldmh5n63Z/U2yzwRqGG6fX+ruI80/XeNdas7icFv6EYOHWRpBoW5Zc/sVjC+o
# NIYblZQSmEiZsRtqAfWerRJHgsk+YtDXmatlmzT/jkngpHVK9cM7FHqZp3WQeeBA
# v5f2q01IJDrOlJ3J1h3Ui/ZBAEI14a9MOTUhD5AdQWFL6HH8bNNz7KGCA0gwggNE
...
# MTkyMjQ3NTRaMC8GCSqGSIb3DQEJBDEiBCC3UhMZCmDoF0B4xXaO+3b18+vvRZVG
# uDE/P+WEHzWtWzA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDZyqvDIltwMM24PjhG
...
# BIIBAJ5WKGkxRyNQfBy3HFfu8B/fVEXRBgsA7cMX71MzQPWP82NtexN4WYmBd641
# 5593w5V2DGlX8i1+WbZmKrvt3vncIJG4yFx/GH7CMDmgigmrjRcG563mraBfMQnV
# YPbC1z7j7GOogFGvwHpj/tXyiNp6yPHXvy6jLA/quT6X03OaxLAqKhIyxG9gClDR
# hCrKkseHyn1Pq4uplDoO3LR05ppmLCIP7gE0axr/xkWArNuqnYiKYPtpLhiZVMeA
# qNMW5S9Lia1mzHMtSSYGboqz6ImkAGhXwwh97Oso8AngZJIPn5WZ6yMWSExFrGLa
# IqLlYMbiiFO9MEQbdZx+nvNdd9Q=
