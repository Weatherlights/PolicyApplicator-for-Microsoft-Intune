...
For ( $i = 0; $i -lt $policyMap.count; $i++ ) {
    ...
    $policyxPathXmlCompatible = ConvertTo-XmlCompatibleString $policyxPath
...
<data id="'+$policyNameXmlCompatible+'-xpath" value="'+$policyxPathXmlCompatible+'"/>
<data id="'+$policyNameXmlCompatible+'-namespace" value="'+$policyNamespaceValue+'"/>';
...
# Set-AuthenticodeSignature "$env:userprofile\GitHub\PolicyApplicator-for-Microsoft-Intune\Code\Convert-XmlToOMACSVTemplate.ps1" @(Get-ChildItem cert:\CurrentUser\My -codesigning)[0] -TimestampServer http://time.certum.pl
# SIG # Begin signature block
# MIIk+QYJKoZIhvcNAQcCoIIk6jCCJOYCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQULPZ/4UNeRSQSh2pJnAeYIDZh
# 5FGggh4pMIIFCTCCA/GgAwIBAgIQDapMmE8NUKJDb44cpXT3cDANBgkqhkiG9w0B
...
# DAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUUjDtMACs+3PvYD10VWRBGy39
# 7zkwDQYJKoZIhvcNAQEBBQAEggEAs0VeSNhDYCwz6RVnd2Q/Of7mIIFB/31+Xh8u
# 3Op4u05ufLeqSH+GRyOBpC4tXyYM9a01vfL7N+ZmEg6jf3B6kliKZPnTp+VTk2zW
# DQ8hLi4pSoKEdXDOEhnIdLuuRZvgHKco+3NM9X/ePLVL4H6oH1nfLUzCrjE9UtCU
# chTu/XL6X948SfO4SaX8hQKazqhN+oO04Fl7YZaucywgEAz5gKTYHmJepzgAtJiW
# bUrhKmgXYcH6AkS3n8ZzMqv5fv0HggI5psJt22dLmI0mKSPuFlohVLLdjnjR0Y0R
# 92C2GdbCYbdoxex1H0e+IJSHYFXXJSIufLLMqpgHvtIfMBV8yKGCBAQwggQABgkq
...
# MjEwOTI3MTAzNjA5WjA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCAbWb/o5XcrrPZD
# u3mstI6BWHhPIcVUrhNHbToaPgXF0zA/BgkqhkiG9w0BCQQxMgQwYegYpn0czh8+
# qUl+gnNQ2dEMAaBsB2Ck2z3yZ4noPXqlJ70C4gnnJ/qxNwwJpwtcMIGgBgsqhkiG
...
# 4nviDjJgjkv0qDANBgkqhkiG9w0BAQEFAASCAgCnkOumLUbu4qay2sHuypo6vKTH
# Rgc1arFHwIaurP5A3Ij08S4bJkQuHB0kMvxis1RX1nfZuTUhr28xHiJ+gan4Itap
# sVXbDNBGZFVsyCV4ruZ7q5ioSHhncgWntdTwLdQdUDbjuZ2CL8798UF7QAwQ5aRl
# wyXtAhWS+Vj32v9ekR3SZtUS38jI+Sw33UFUXer8aj8JwMFEs6D5lq+pEd/pKJPZ
# leikV9yBO0Xtie5qhzQte++NqqjKXpoYqc9BHfmeGpkzPLh2/GT+aBypSHQ2ENiI
# 7NYXjLf+BlNRhl6q71Zj7TiqqqSfNBX9MPdPgDFk1eeBdUvVHMRMIaA2WS0Yd90Z
# i6OdGlQaqNyCN0jDzYIts94NUX2qYnL2ituogN/bLIPjo1gQhlKLD0oP3MmjnIF5
# Au8Pd2ogAgWze0vepASqOggBwCEJSmdDgOEUAQbHqvZ3KCUtSMyS+XiBX0eulo4m
# PxWtiVK3AQE9/meO4u6Y0n05YUsUWaGobumtSLZrh4C+3K+531YZICumiZrB7FF6
# uidfbrmCvxvLLmi7f9IqOCXL2+XTWtu2fpgQL4VGur0HQO49Wrhg++DvB8X27bAL
# aXQCuMF9NnNnAhKnVSEpqMfDqXuP7qQfyvOtRc5UPywZKPxTiqW6dL1L4J7gQcI6
# IBXflptXv0THNeZCxw==
